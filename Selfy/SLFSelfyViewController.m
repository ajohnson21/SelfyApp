...
-(void)submitButton
{
    ...
    PFFile * imageFile = [PFFile fileWithName:@"ship" data:imageData];
    
    PFObject *newPhoto = [PFObject objectWithClassName:@"newPhoto"];
    newPhoto[@"imageName"] = @"It's a ship";
    newPhoto[@"imageFile"] = imageFile;
